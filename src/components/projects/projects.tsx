    ...
    return <section id='projects' className={classes.projectsSection}>
        <div className={classes.projectsContainer}>
            ...
            <div className={classes.projects}>
                <div className={classes.project}><h3>MOOWIZ - Netflix clone</h3><img src={mooviz} alt='mooviz, netflix clone photo' className={classes.projectImage} /><p>Moowiz is a Netflix clone website. It utilizes TMDB to fetch movies. Users can watch movie trailers, add movies to their watchlist, and search for specific movies they desire.</p><div className={classes.technologiesContainer}>
